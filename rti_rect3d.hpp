...
#include "rti_vec.hpp"
//#include "rti_line.hpp"
//#include "rti_patient.hpp"

namespace rti{

/**
 * The <code>rect3d</code> class represents a 3D rectlinear grid 
 * to hold data of dose, CT, and DVF (deformation vector field).
 *
 * @tparam T for grid values, e.g., dose, HU, vector
...
protected:
    ...
    R* x_;  /**< x axis values. each value means the center of pixel */
    R* y_;  /**< y axis values. each value means the center of pixel */
    R* z_;  /**< z axis values. each value means the center of pixel */
...
public:
    ...
    *
    * @param[in] x,y,z  1D vector of central points of voxels along x-axis
    ...
    *
    * @param[in] x,y,z  1D array of central points of voxels along x-axis
    *            for example, -1,0,1 mean three voxels along x.
    * @param[in] xn,yn,zn  size of 1D array for points.
    */
    CUDA_HOST_DEVICE
    rect3d(
        R x[], int xn,
    ...
    */
    ...
    /**
    * Return the interpolated value for given point, p. in std::array type
    * @param[in] p is a std::array to represent a position, p[0], p[1], p[2] for x, y, z.
    */
    CUDA_HOST_DEVICE
    virtual T 
    operator()(
    ...
    * @param[in] x, y, z are for position
    */
    CUDA_HOST_DEVICE
    virtual T 
    operator()(
        const R x, const R y, const R z)
    {
   ...
   /**
   * Return the interpolated value for given point, x, y, z
   * @param[in] pos is a type of rti::vec3<R>.
   */
    CUDA_HOST_DEVICE
    virtual T 
    operator()(
    ...
    /**
    * Return the data value for given x/y/z index
    * @param[in] p index, p[0], p[1], p[2] for x, y, z.
    */
    CUDA_HOST_DEVICE
    virtual T 
    operator[](
        const std::array<size_t,3> p)
    {
    ...
    */
    ...
    /**
    * Return a total of 8 coner data of a cell
    * @param[in] c000_idx is an array having cell ids of x, y, and z.
    * return coner values of a cell, C000, C001, C100, etc.
    */
    CUDA_HOST_DEVICE
    virtual std::array<T, 8>& 
    cell_data(
        const std::array<size_t,3>& c000_idx)
    {
   ...
   /**
   * Return a total of 6 values of position 
   * @param[in] c000_idx is an array having cell ids of x, y, and z.
   ...
   */
   ...
   /**
   * Return a coner index (x,y,z) where a given position is placed within (x+1,y+1,z+1)
   * @param[in] pos cartesian coordinate of x, y, and z.
   ...
   */
    ...
    * note: more accurately, the center should be middle of edge
    ...
    */
    ...
    /**
    * print out x,y,z coordinate positions
    */
    CUDA_HOST
    virtual void
    dump_pts(){ //print edges
    ...
    /** 
    * Convert index of x,y,z to index of valarray(data)
    */
    CUDA_HOST_DEVICE
    virtual inline 
    size_t
    ...
    */
    ...
    /**
    * Write out any type of valarray
    */
    CUDA_HOST
    template<class S>
    void
    ...
    */
    ...
    /**
    * initialize data, currently values are sum of index square for testing
    */
    CUDA_HOST
    virtual void
    load_data(){
    ...
    /**
    * read data from other source,  currently values are sum of index square for testing
    ...
    */
    ...
    /**
    * Check data is flipped from x_, y_, z_
