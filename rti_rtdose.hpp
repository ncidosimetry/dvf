...
public: 
    ...
    */
    ...
    /**
    * Initialize data by reading PixelData in RTDOSE
    ...
    */
    ...
    template<class S>
    void
    transform_to_float(std::valarray<S>& in, float inter, float slope){
        std::transform(begin(in), end(in), 
                       begin(rect3d<float,R>::data_),  //member 
